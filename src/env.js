...
export const env = createEnv({
  ...
  server: {
    ...
    KIRIMI_USER_CODE: z.string().optional(),
    KIRIMI_DEVICE_ID: z.string().optional(),
    KIRIMI_SECRET_KEY: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    KIRIMI_USER_CODE: process.env.KIRIMI_USER_CODE,
    KIRIMI_DEVICE_ID: process.env.KIRIMI_DEVICE_ID,
    KIRIMI_SECRET_KEY: process.env.KIRIMI_SECRET_KEY,
