...
export function PropertyList({
  ...
  return (
    <div className={cn("space-y-6", className)}>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Kelola dan monitor semua properti di platform
          </p>
        </div>
      </div>
      ...
      {/* Active Filters */}
      {(currentSearch || (currentStatus && currentStatus !== "ALL") || (currentType && currentType !== "ALL")) && (
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {currentStatus && currentStatus !== "ALL" && (
            <Badge variant="secondary" className="gap-1">
              ...
              <button onClick={() => handleStatusChange("ALL")} className="ml-1 hover:bg-muted-foreground/20 rounded-full p-0.5">
                ×
              </button>
            </Badge>
          )}
