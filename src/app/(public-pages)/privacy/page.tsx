...
import { Shield, Calendar, ArrowLeft, BookOpen, Lock } from "lucide-react";
...
export default function PrivacyPage() {
    ...
    useEffect(() => {
        const fetchContent = async () => {
            try {
                const response = await fetch("/api/public/site-content?type=privacy");
            ...
            <main className="flex-1">
                ...
                <section className="relative overflow-hidden pt-20 pb-12 lg:pt-28 lg:pb-16">
                    ...
                    <div className="absolute inset-0 -z-10">
                        ...
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-[300px] bg-emerald-500/10 blur-[120px] rounded-full" />
                    </div>
                    ...
                    <div className="container mx-auto px-4 text-center">
                        <motion.div
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 text-emerald-600 mb-6 border border-emerald-500/20"
                        >
                            <Shield className="h-4 w-4" />
                            <span className="text-sm font-medium">Perlindungan Data</span>
                        </motion.div>
                        ...
                        <motion.h1
                            ...
                            className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4 bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent"
                        >
                            {isLoading ? "Memuat..." : content?.title || "Kebijakan Privasi"}
                        </motion.h1>
                ...
                <section className="py-8 lg:py-12">
                    <div className="container mx-auto px-4">
                        <div className="max-w-4xl mx-auto">
                            ...
                            >
                                <Link href="/">
                                    <Button variant="ghost" size="sm" className="gap-2 hover:bg-emerald-500/10">
                                ...
                                {isLoading ? (
                                    ...
                                    <div className="p-8 lg:p-12">
                                        ...
                                        <div className="flex items-center gap-3 pb-6 mb-8 border-b border-border/50">
                                            <div className="flex items-center justify-center h-12 w-12 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white">
                        ...
                        prose-a:text-emerald-600 prose-a:underline prose-a:underline-offset-4 prose-a:hover:text-emerald-700"
                            ...
                            {content && (
                                ...
                                >
                                    Dengan menggunakan layanan myHome, Anda menyetujui kebijakan privasi ini.
                                </motion.p>
                            )}
                        </div>
                    </div>
